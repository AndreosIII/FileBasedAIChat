...
def anthropic_format_messages(conversation):
    """
...
def anthropic_send_request_to_model(model, api_key, api_base, behavior_description, temperature, messages):
    """
...
def communicate_with_anthropic(api_key, api_base, dialog_data):
    """
    ...
    response = anthropic_send_request_to_model(model_name, api_key, api_base, behavior_description, temperature, messages)
